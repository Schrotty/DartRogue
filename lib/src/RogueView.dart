...
class RogueView {
  ...
  final ButtonInputElement backNameInputButton =
      querySelector("#name-input-back");
  ...
  final ButtonInputElement backGameOverButton =
      querySelector("#back-game-over");
  ...
  final ButtonInputElement potionsMenuButton =
      querySelector("#potion-screen-button");

  final Element eventWindow = querySelector("#event-window");
  final Element eventText = querySelector("#event-text");
  final ButtonInputElement hideEventButton =
      querySelector("#hide-event-button");
  ...
  /* PREVIEW ITEM */
  final Element previewItemName =
      querySelector("#preview-item #preview-item-name");
  final Element previewItemIcon =
      querySelector("#preview-item #preview-item-icon");
  final Element previewItemQuality =
      querySelector("#preview-item #preview-item-quality");
  final Element previewItemType =
      querySelector("#preview-item #preview-item-type");
  final Element previewItemValue =
      querySelector("#preview-item #preview-item-value");
  final Element previewItemKey =
      querySelector("#preview-item #preview-item-key");
  final Element previewItemMods =
      querySelector("#preview-item #preview-item-mods ul");
